package com.example.hifive.security.manager

import android.security.keystore.KeyGenParameterSpec
import android.security.keystore.KeyProperties
import com.example.hifive.security.EncryptedData
import com.example.hifive.security.handler.CryptographyHandler
...
class CryptographyManager : CryptographyHandler {
    ...
    override fun getInitializedCipherForDecryption(keyName: String, initVector: ByteArray): Cipher {
        val cipher = getCipher()
        val secretKey = getOrCreateSecretKey(keyName)
        cipher.init(Cipher.DECRYPT_MODE, secretKey, GCMParameterSpec(128, initVector))
        return cipher
    }
